...
const String addDialogTitle = "Location Name Tag";
const String addDialogCancelBtn = "Cancel";
const String addDialogAddBtn = "Add";
const String addDialogHintText = "Enter Location tag name here!";
